...
process.stdin.on('end', () => {
  try {
    ...
    if (task) {
      process.stdout.write(`${driveUpdate}\x1b[2m${model}\x1b[0m | \x1b[1m${task}\x1b[0m | \x1b[2m${dirname}\x1b[0m${ctx}`);
    } else {
      process.stdout.write(`${driveUpdate}\x1b[2m${model}\x1b[0m | \x1b[2m${dirname}\x1b[0m${ctx}`);
    }
  } catch (e) {
