...
1. **drive-phase-researcher** -- Reads context.md to know WHAT to research
   - "User wants card-based layout" -> researcher investigates card component patterns
   - "Infinite scroll decided" -> researcher looks into virtualization libraries

2. **drive-planner** -- Reads context.md to know WHAT decisions are locked
...
Use /drive:progress to see available phases.
```
...
**Also available:**
- `/drive:plan-phase ${PHASE} --skip-research` -- plan without research
