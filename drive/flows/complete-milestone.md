...
When a milestone completes, this flow:
...
```
AUTO: Auto-approved: Milestone scope verification
...
5. **Key Decisions audit:**
   ...
   - Mark ✓ Good, WARNING Revisit, or -- Pending for each
...
- DONE **v1.0 MVP** -- Phases 1-4 (shipped YYYY-MM-DD)
- IN-PROGRESS **v1.1 Security** -- Phases 5-6 (in progress)
- PLANNED **v2.0 Redesign** -- Phases 7-10 (planned)

## Phases

<details>
<summary>DONE v1.0 MVP (Phases 1-4) -- SHIPPED YYYY-MM-DD</summary>
...
### IN-PROGRESS v[Next] [Name] (In Progress / Planned)
...
2. Read `~/.claude/drive/templates/milestone-archive.md` template
...
9. Confirm roadmap archive complete:
   ...
   ```
   DONE v[X.Y] roadmap archived to milestones/v[X.Y]-roadmap.md
   DONE roadmap.md deleted (fresh one for next milestone)
   ```
...
6. Confirm:
   ...
   ```
   DONE Requirements archived to milestones/v[X.Y]-requirements.md
   DONE requirements.md deleted (fresh one needed for next milestone)
   ```

**Important:** The next milestone flow starts with `/drive:new-milestone` which includes requirements definition. project.md's Validated section carries the cumulative record across milestones.
...
```
DONE Audit archived to milestones/v[X.Y]-MILESTONE-audit.md
```
...
```
DONE Milestone v[X.Y] [Name] complete
...
- [ ] User knows next step (/drive:new-milestone)
