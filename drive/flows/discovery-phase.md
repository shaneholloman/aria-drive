...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /drive:research-phase instead, which produces research.md.
</purpose>

<depth_levels>
**This flow supports three depth levels:**
...
See ~/.claude/drive/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
Route to appropriate level flow below.
</step>
...
6. **Create discovery.md** using ~/.claude/drive/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/drive/templates/discovery.md:
...
6. **Create comprehensive discovery.md:**
   ...
   - Full structure from ~/.claude/drive/templates/discovery.md
...
Use ~/.claude/drive/templates/discovery.md.
...
1. Discuss phase context (/drive:discuss-phase [current-phase])
2. Create phase plan (/drive:plan-phase [current-phase])
