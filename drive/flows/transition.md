...
Exit skill and invoke SlashCommand("/drive:plan-phase [X+1]")
...
**Also available:**
- `/drive:discuss-phase [X+1]` -- gather context first
- `/drive:research-phase [X+1]` -- investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("/drive:complete-milestone {version}")
