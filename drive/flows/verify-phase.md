...
This flow is executed by a verification subagent spawned from execute-phase.md.
</purpose>
...
<required_reading>
@~/.claude/drive/references/verification-patterns.md
@~/.claude/drive/templates/verification-report.md
</required_reading>
...
<!-- Goal-backward derivation expertise is baked into the drive-verifier agent -->
</step>
...
- BLOCKER: Blocker: Prevents goal achievement (placeholder renders, empty handlers)
- WARNING Warning: Indicates incomplete (TODO comments, console.log)
...
See ~/.claude/drive/templates/verification-report.md for complete template.
</step>
