...
- This section feeds directly into /drive:plan-phase --gaps
...
2. diagnose-issues flow spawns parallel debug agents
3. Each agent investigates one gap, returns root cause
4. uat.md Gaps section updated with diagnosis:
   - Each gap gets `root_cause`, `artifacts`, `missing`, `debug_session` filled
5. status -> "diagnosed"
6. Ready for /drive:plan-phase --gaps with root causes
...
**Creation:** When /drive:verify-work starts new session
