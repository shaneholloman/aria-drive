...
Template for spawning drive-debugger agent. The agent contains all debugging expertise - this template provides problem context only.
...
```python
Task(prompt=template, subagent_type="drive-debugger", description="Debug UAT-001")
```
