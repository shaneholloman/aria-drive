...
This template is used by the complete-milestone flow to create archive files in `.planning/milestones/`.
...
- Some flows still have hardcoded paths (fix in Phase 5)
...
- Triggered by complete-milestone flow
