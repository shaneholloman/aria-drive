...
|   `-------- drive/           # Aria Drive-specific commands
|-------- aria-drive/     # Skill resources
...
- Contains: Flow definitions called by commands
...
- Plural for collections: templates/, commands/, flows/
...
**New Slash Command:**
- Primary code: `commands/drive/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `readme.md` with new command

**New Template:**
- Implementation: `aria-drive/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Flow:**
- Implementation: `aria-drive/flows/{name}.md`
- Usage: Reference from command with `@~/.claude/drive/flows/{name}.md`

**New Reference Document:**
- Implementation: `aria-drive/references/{name}.md`
- Usage: Reference from commands/flows as needed
