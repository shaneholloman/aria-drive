...
<task type="checkpoint:decision" gate="blocking">
  ...
  <options>
    ...
    <option id="planetscale">
      ...
      <pros>Serverless scaling, branching flow, excellent DX</pros>
...
- Assume knowledge: "Configure the usual settings" FAILED
- Skip steps: "Set up database" FAILED (too vague)
...
- Before Claude automates (asking human to do automatable work) FAILED
- Too frequent (every other task is a checkpoint) FAILED
- Too late (checkpoint is last task, but earlier tasks needed its result) FAILED
</writing_guidelines>
...
### FAILED BAD: Asking user to start dev server
...
### DONE GOOD: Claude starts server, user visits
...
### FAILED BAD: Asking user to add env vars in dashboard
...
### DONE GOOD: Claude collects secret, adds via CLI
...
### FAILED BAD: Asking human to deploy
...
### DONE GOOD: Claude automates, human verifies
...
### FAILED BAD: Too many checkpoints
...
### DONE GOOD: Single verification checkpoint
...
### FAILED BAD: Asking for automatable file operations
...
### FAILED BAD: Vague verification steps
...
### DONE GOOD: Specific verification steps (server already running)
...
### FAILED BAD: Asking user to run any CLI command
...
### FAILED BAD: Asking user to copy values between services
