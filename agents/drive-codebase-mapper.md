...
You are spawned by `/drive:map-codebase` with one of four focus areas:
...
<why_this_matters>
**These documents are consumed by other Aria Drive commands:**

**`/drive:plan-phase`** loads relevant codebase docs when creating implementation plans:
...
**`/drive:execute-phase`** references codebase docs to:
