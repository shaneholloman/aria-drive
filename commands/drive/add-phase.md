...
- Example: `/drive:add-phase Add authentication` -> description = "Add authentication"
- Example: `/drive:add-phase Fix critical performance issues` -> description = "Fix critical performance issues"

If no arguments provided:

```
ERROR: Phase description required
Usage: /drive:add-phase <description>
Example: /drive:add-phase Add authentication system
```
...
2. Insert new phase heading:
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (run /drive:plan-phase {N} to break down)
...
**Also available:**
- `/drive:add-phase <description>` -- add another phase
- Review roadmap
...
- Don't use decimal numbering (that's /drive:insert-phase)
- Don't create plans yet (that's /drive:plan-phase)
