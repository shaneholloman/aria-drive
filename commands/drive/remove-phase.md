...
- Example: `/drive:remove-phase 17` -> phase = 17
- Example: `/drive:remove-phase 16.1` -> phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /drive:remove-phase <phase-number>
Example: /drive:remove-phase 17
```
...
To abandon current work, use /drive:pause-work instead.
```
...
Would you like to:
- `/drive:progress` -- see updated roadmap status
