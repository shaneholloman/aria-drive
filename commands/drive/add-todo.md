...
<objective>
Capture an idea, task, or issue that surfaces during an Aria Drive session as a structured todo for later work.
...
- `/drive:add-todo Add auth token refresh` -> title = "Add auth token refresh"
...
2. Add another todo
3. View all todos (/drive:check-todos)
